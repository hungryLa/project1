...
<html lang="en">
  ...
  <header class="header-bar d-flex d-lg-block align-items-center site-navbar-target" data-aos="fade-right">
    <div class="site-logo">
      <a href="index.blade.php">Elit Photo</a>
    </div>
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        <li><a href="index.blade.php#section-home" class="nav-link">Home</a></li>
        <li><a href="index.blade.php#section-photos" class="nav-link">Photos</a></li>
        <li><a href="index.blade.php#section-bio" class="nav-link">Biography</a></li>
        <li class="active"><a href="index.blade.php#section-blog" class="nav-link">Blog</a></li>
        <li><a href="index.blade.php#section-contact" class="nav-link">Contact</a></li>
      </ul>
